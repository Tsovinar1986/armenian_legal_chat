...
Usage:
    ...
    if not input_result.passed and input_result.category in ("prompt_injection", "indecent_language"):
...
"""
from src.guardrails.input_guardrails import run_input_guardrails
